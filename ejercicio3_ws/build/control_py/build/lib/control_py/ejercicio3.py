...
class WaypointNavigator(Node):
    def __init__(self):
        ...
        self.front_distance = float('inf')
         ...
         #  waypoints hacia el objetivo
        self.waypoints = [(0.27, 6.67 ), (0.08, 3.27), (-3.46, 3.19), (-3.57, -2.60), (-8.27, -2.79), (-3.57, -2.60), (-3.46, 3.29)
                        , (0.33, 3.29), (0.30, -3.25), (0.19, 6.62)

                        , (8.85, 6.64), (8.85, 0.95) , (5.61, 0.74), (5.45, -4.96) , (5.61, 0.74) , (8.85, 0.95) , (8.80, -4.80)
                        , (8.77, 6.66), (-9.77, 6.80)] 
